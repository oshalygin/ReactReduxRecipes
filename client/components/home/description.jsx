    ...
    return (
        <div>
            ...
            <ol>
                ...
                <li>Run <kbd>npm start -s</kbd> to kick off the application.It should automatically load a browser window and point to <code>http://localhost:9999</code>.  If the browser window does not load then manually navigate to <code>http://localhost:9999</code>.</li>
            ...
            <h4>Sample application which implements the following requirements:</h4>
            <ul>
                <li>Using the provided JSON data representing a collection of meal recipes, create a micro frontend application that meets the following criteria:</li>
